...
pass_type_enum = postgresql.ENUM(
    *("COURAGE_PASS", "ADVENTURE_BOSS_PASS", "WORLD_CLEAR_PASS"), name="passtype"
)
...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        "claim_season_pass_id_fkey", "claim", "season_pass", ["season_pass_id"], ["id"]
    )
    op.add_column(
        "season_pass",
        sa.Column(
            "pass_type", pass_type_enum, server_default="COURAGE_PASS", nullable=False
        ),
    )
    op.alter_column(
        "season_pass",
