    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        if config.stage == "mainnet":
            self.rds = _rds.DatabaseCluster(
                ...
                engine=_rds.DatabaseClusterEngine.aurora_postgres(version=_rds.AuroraPostgresEngineVersion.VER_15_6),
            ...
            self.rds = _rds.DatabaseInstance(
                ...
                engine=_rds.DatabaseInstanceEngine.postgres(version=_rds.PostgresEngineVersion.VER_15_6),
                vpc=self.vpc,
