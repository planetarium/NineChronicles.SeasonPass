...
TX_STATUS_ENUM = postgresql.ENUM(
    *('CREATED', 'STAGED', 'SUCCESS', 'FAILURE', 'INVALID', 'NOT_FOUND', 'FAIL_TO_CREATE', 'UNKNOWN'),
    name="txstatus", create_type=False
)
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('reward_list', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
